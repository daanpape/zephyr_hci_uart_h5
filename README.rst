...
using the H:5 HCI transport protocol. This allows the controller to be connected
to the host without hardware flow control.
...
This sample can be found under :zephyr_file:`samples/bluetooth/hci_uart_h5` in the
...
.. code-block:: console
   ...
   sudo btattach -B /dev/ttyACM0 -S 1000000 -R -N -P 3wire
...
.. code-block:: console
   ...
   sudo btattach -B /dev/ttyACM0 -S 1000000 -N -P 3wire
